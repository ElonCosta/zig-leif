...
pub const PFNGLBLITFRAMEBUFFERLAYERSEXTPROC = ?*const fn (GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum) callconv(.C) void;
pub const PFNGLBLITFRAMEBUFFERLAYEREXTPROC = ?*const fn (GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum) callconv(.C) void;
...
pub const offsetof = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /home/elon/.asdf/installs/zig/0.12.0/lib/include/stddef.h:116:9
...
pub const GLAPI = @compileError("unable to translate macro: undefined identifier `visibility`"); // /usr/include/GL/gl.h:50:11
pub const APIENTRYP = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/GL/gl.h:83:9
pub const GLAPIENTRYP = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/GL/gl.h:87:9
...
pub const GL_GLEXT_VERSION = @import("std").zig.c_translation.promoteIntLiteral(c_int, 20230309, .decimal);
...
pub const GL_EXT_framebuffer_blit_layers = @as(c_int, 1);
...
pub const GL_MESA_texture_const_bandwidth = @as(c_int, 1);
pub const GL_CONST_BW_TILING_MESA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8BBE, .hex);
